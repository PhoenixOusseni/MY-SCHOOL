                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        <h1 class="page-header-title">
                            ...
                            Nouveau détail de bulletin
                        </h1>
                        <p class="text-muted">Ajouter une matière au bulletin d'un élève</p>
                    </div>
                    <div class="col-auto mt-4">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="bulletin_id" class="form-select @error('bulletin_id') is-invalid @enderror" required>
                                ...
                                @foreach($bulletins as $bulletin)
                                    <option value="{{ $bulletin->id }}" @selected(old('bulletin_id') == $bulletin->id)>
