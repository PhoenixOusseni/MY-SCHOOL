                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        ...
                        <div class="page-header-subtitle text-white-75">
                            <small>Statistiques d'absences, retards et justifications</small>
                        </div>
                    </div>
                    <div class="col-auto mt-4">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="card shadow border-start-5 border-start-danger h-100">
                            <div class="card-body d-flex align-items-center gap-3">
                                <div class="bg-danger rounded p-3"><i
                                        class="fas fa-exclamation-triangle text-white fa-lg"></i></div>
                                <div>
                                    <div class="text-muted small">Total incidents</div>
                                    <div class="fs-4 fw-bold">{{ $totaux['incidents'] }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="card shadow border-start-5 border-start-warning h-100">
                            <div class="card-body d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <div class="text-muted small">Sanctions</div>
                                    <div class="fs-4 fw-bold">{{ $totaux['sanctions'] }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="card shadow border-start-5 border-start-dark h-100">
                            <div class="card-body d-flex align-items-center gap-3">
                                <div class="bg-dark rounded p-3"><i class="fas fa-skull-crossbones text-white fa-lg"></i>
                                </div>
                                <div>
                                    <div class="text-muted small">Incidents graves</div>
                                    <div class="fs-4 fw-bold text-danger">{{ $totaux['graves'] }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="card shadow border-start-5 border-start-info h-100">
                            <div class="card-body d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <div class="text-muted small">Parents notifiés</div>
                                    <div class="fs-4 fw-bold">{{ $totaux['parents_notifies'] }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-7">
                        <div class="card shadow h-100">
                            <div class="card-header bg-white py-3 fw-bold"><i
                                    class="fas fa-chart-line text-danger me-2"></i>Évolution mensuelle des incidents</div>
                    ...
                    <div class="col-lg-5">
                        <div class="card shadow h-100">
                            <div class="card-header bg-white py-3 fw-bold"><i
                                    class="fas fa-chart-pie text-warning me-2"></i>Types d'incidents</div>
                    ...
                    <div class="col-lg-7">
                        <div class="card shadow">
                            <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                                <span class="fw-bold"><i class="fas fa-table text-secondary me-2"></i>Incidents par
                                    classe</span>
                            </div>
                                            ...
                                            <tbody>
                                                @foreach ($parClasse as $row)
                                                    <tr>
                                                        ...
                                                        <td class="text-center fw-bold text-danger">{{ $row->total }}
                                                        </td>
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header bg-white py-3 fw-bold"><i
                                    class="fas fa-user-times text-danger me-2"></i>Top élèves (incidents)</div>
                                ...
                                @forelse($topEleves as $i => $row)
                                    <div class="list-group-item d-flex align-items-center justify-content-between py-2">
                                        <div class="d-flex align-items-center gap-2">
                                            <span
                                                class="badge {{ $i < 3 ? 'bg-danger' : 'bg-light text-dark border' }} rounded-pill">{{ $i + 1 }}</span>
                                            <div>
                                                <div class="fw-semibold small">{{ $row->prenom }} {{ $row->nom }}
                                                </div>
                        ...
                        <div class="card shadow">
                            <div class="card-header bg-white py-3 fw-bold"><i
                                    class="fas fa-gavel text-warning me-2"></i>Sanctions par type</div>
                            <div class="list-group list-group-flush">
