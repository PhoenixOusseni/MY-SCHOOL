                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <p class="h5">{{ $retard->date ? $retard->date->format('d/m/Y') : '-' }}</p>
                            </div>
                            <div class="col-md-6">
                                <p class="text-muted mb-1">Heure d'arrivée</p>
                                <p class="h6">{{ $retard->heure_arrivee ?? '-' }}</p>
                            </div>
                        </div>

                        <div class="row mb-3">
                            <div class="col-md-6">
                                <p class="text-muted mb-1">Durée du retard</p>
                                <p class="h6">{{ $retard->duree ? $retard->duree . ' min' : '-' }}</p>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <p class="h6">{{ $retard->eleve->prenom ?? '' }} {{ $retard->eleve->nom ?? 'N/A' }}</p>
                            </div>
                            <div class="col-md-6">
                                <p class="text-muted mb-1">Classe</p>
                                <p class="h6">{{ $retard->classe->nom ?? 'N/A' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <p class="h6">{{ $retard->matiere->intitule ?? '-' }}</p>
                            </div>
                            <div class="col-md-6">
                                <p class="text-muted mb-1">Signalé par</p>
                                <p class="h6">
                                    @if ($retard->reportedBy)
                                        {{ $retard->reportedBy->prenom }} {{ $retard->reportedBy->nom }}
                                    @else
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <p class="h6">{{ $retard->reported_at ? $retard->reported_at->format('d/m/Y H:i') : '-' }}</p>
                            </div>
                        </div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <a href="{{ route('gestion_retards.edit', $retard->id) }}" class="btn btn-dark btn-sm">
