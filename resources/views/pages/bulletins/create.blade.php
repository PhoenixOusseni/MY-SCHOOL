...
@section('content')
    ...
    <div class="container-xl px-4 mt-n10">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('gestion_bulletins.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" step="0.01" min="0" name="moyenne_globale" value="{{ old('moyenne_globale') }}" class="form-control @error('moyenne_globale') is-invalid @enderror">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" min="1" name="total_eleves" value="{{ old('total_eleves') }}" class="form-control @error('total_eleves') is-invalid @enderror">
                            @error('total_eleves') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-3 mb-3">
                            <label class="form-label">Mention conduite</label>
                            <input type="text" name="mention_conduite" value="{{ old('mention_conduite') }}" class="form-control @error('mention_conduite') is-invalid @enderror">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" step="0.01" min="0" name="total_points" value="{{ old('total_points') }}" class="form-control @error('total_points') is-invalid @enderror">
                            @error('total_points') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-3 mb-3">
                            <label class="form-label">Total coefficient</label>
                            <input type="number" step="0.01" min="0" name="total_coefficient" value="{{ old('total_coefficient') }}" class="form-control @error('total_coefficient') is-invalid @enderror">
                            @error('total_coefficient') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-2 mb-3">
                            <label class="form-label">Absences</label>
                            <input type="number" min="0" name="absences" value="{{ old('absences', 0) }}" class="form-control @error('absences') is-invalid @enderror">
                            @error('absences') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-2 mb-3">
                            <label class="form-label">Justifiées</label>
                            <input type="number" min="0" name="justification_absences" value="{{ old('justification_absences', 0) }}" class="form-control @error('justification_absences') is-invalid @enderror">
                            @error('justification_absences') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-2 mb-3">
                            <label class="form-label">Retards</label>
                            <input type="number" min="0" name="retards" value="{{ old('retards', 0) }}" class="form-control @error('retards') is-invalid @enderror">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                                <option value="brouillon" @selected(old('status') === 'brouillon')>Brouillon</option>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="datetime-local" name="generated_at" value="{{ old('generated_at') }}" class="form-control @error('generated_at') is-invalid @enderror">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="commentaire_principal" rows="3" class="form-control @error('commentaire_principal') is-invalid @enderror">{{ old('commentaire_principal') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="commentaire_directeur" rows="3" class="form-control @error('commentaire_directeur') is-invalid @enderror">{{ old('commentaire_directeur') }}</textarea>
