            ...
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        ...
                        <p class="text-muted">Créer une nouvelle note pour un élève</p>
                    </div>
                    <div class="col-auto mt-4">
                        <a href="{{ route('gestion_notes.index') }}" class="btn btn-dark btn-sm">
    ...
    <div class="container-xl px-4 mt-n10">
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('gestion_notes.store') }}" method="POST" id="noteForm">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('evaluation_id') is-invalid @enderror" id="evaluation_id" name="evaluation_id" required>
                                    ...
                                    @foreach($evaluations as $evaluation)
                                        <option value="{{ $evaluation->id }}" @selected(old('evaluation_id') == $evaluation->id)>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="is_absent" name="is_absent" @checked(old('is_absent'))>
                            ...
                            <div id="absenceFields" style="display: none;">
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="absence_justified" name="absence_justified" @checked(old('absence_justified'))>
                            ...
                            <div id="scoreFields">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('score') is-invalid @enderror" id="score" name="score" value="{{ old('score') }}" placeholder="ex: 15" step="0.01" min="0">
                                        @error('score')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('max_score') is-invalid @enderror" id="max_score" name="max_score" value="{{ old('max_score', '20') }}" placeholder="20" step="0.01" min="0" required>
                                        @error('max_score')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('entered_by') is-invalid @enderror" id="entered_by" name="entered_by">
                                    ...
                                    @foreach($enseignants as $enseignant)
                                        <option value="{{ $enseignant->id }}" @selected(old('entered_by') == $enseignant->id)>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('comment') is-invalid @enderror" id="comment" name="comment" rows="3" placeholder="Ajouter un commentaire...">{{ old('comment') }}</textarea>
                                @error('comment')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="m-3">
                                ...
                                <a href="{{ route('gestion_notes.index') }}" class="btn btn-dark">
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="small">
                            <li>Sélectionnez d'abord l'évaluation concernée</li>
                            <li>Choisissez l'élève à noter</li>
                            <li>Si l'élève était absent, cochez la case "Élève absent"</li>
                            <li>Sinon, saisissez la note obtenue et la note maximale</li>
                            <li>Le pourcentage sera calculé automatiquement</li>
                            <li>Vous pouvez ajouter un commentaire si nécessaire</li>
                        </ul>
                    </div>
                </div>
            </div>
