                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        <h1 class="page-header-title">
                            ...
                            Modifier un Frais de Scolarité
                        </h1>
            ...
            <div class="col-lg-8 offset-lg-2">
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('gestion_frais_scolarite.update', $frai->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('libelle', $frai->libelle) }}" required>
                                @error('libelle')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0"
                                        ...
                                        value="{{ old('montant', $frai->montant) }}" required>
                                    @error('montant')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('devise') is-invalid @enderror" id="devise" name="devise">
                                        <option value="XOF" {{ old('devise', $frai->devise) == 'XOF' ? 'selected' : '' }}>XOF (Franc CFA)</option>
                                        <option value="EUR" {{ old('devise', $frai->devise) == 'EUR' ? 'selected' : '' }}>EUR (Euro)</option>
                                        <option value="USD" {{ old('devise', $frai->devise) == 'USD' ? 'selected' : '' }}>USD (Dollar)</option>
                                        <option value="GNF" {{ old('devise', $frai->devise) == 'GNF' ? 'selected' : '' }}>GNF (Franc Guinéen)</option>
                                        <option value="MAD" {{ old('devise', $frai->devise) == 'MAD' ? 'selected' : '' }}>MAD (Dirham)</option>
                                    </select>
                                    @error('devise')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('frequence') is-invalid @enderror" id="frequence" name="frequence" required>
                                        <option value="unique" {{ old('frequence', $frai->frequence) == 'unique' ? 'selected' : '' }}>Unique</option>
                                        <option value="mensuelle" {{ old('frequence', $frai->frequence) == 'mensuelle' ? 'selected' : '' }}>Mensuelle</option>
                                        <option value="trimestrielle" {{ old('frequence', $frai->frequence) == 'trimestrielle' ? 'selected' : '' }}>Trimestrielle</option>
                                        <option value="annuelle" {{ old('frequence', $frai->frequence) == 'annuelle' ? 'selected' : '' }}>Annuelle</option>
                                    </select>
                                    @error('frequence')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <select class="form-select @error('etablissement_id') is-invalid @enderror" id="etablissement_id" name="etablissement_id" required>
                                        ...
                                        @foreach ($etablissements as $etablissement)
                                            <option value="{{ $etablissement->id }}"
                                                {{ old('etablissement_id', $frai->etablissement_id) == $etablissement->id ? 'selected' : '' }}>
                                                {{ $etablissement->nom }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="mb-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch"
                                        ...
                                        {{ old('est_obligatoire', $frai->est_obligatoire) ? 'checked' : '' }}>
